...
# MAGIC %md
# MAGIC # Load Suppliers to Bronze
# MAGIC Loads supplier data from CSV into the bronze layer.
...
csv_path = f"{DATA_PATH}/{CSV_FILES['suppliers']}"
...
table_name = bronze_table("suppliers")
