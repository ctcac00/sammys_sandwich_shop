...
# MAGIC %md
# MAGIC # Load Customers to Bronze
# MAGIC Loads customer data from CSV into the bronze layer.
...
csv_path = f"{DATA_PATH}/{CSV_FILES['customers']}"
...
table_name = bronze_table("customers")
