...
# MAGIC %md
# MAGIC # Load Orders to Bronze
# MAGIC Loads order header data from CSV into the bronze layer.
...
csv_path = f"{DATA_PATH}/{CSV_FILES['orders']}"
...
table_name = bronze_table("orders")
