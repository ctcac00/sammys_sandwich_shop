...
# MAGIC %md
# MAGIC # Load Locations to Bronze
# MAGIC Loads location data from CSV into the bronze layer.
...
csv_path = f"{DATA_PATH}/{CSV_FILES['locations']}"
...
table_name = bronze_table("locations")
