# Sammy's Sandwich Shop - Snowflake Implementation

Snowflake data warehouse implementation demonstrating the transformation of data from raw sources through to analytics-ready reports using the **three-layer architecture**: Raw, Enriched, and Ready.

> **Note**: Seed data CSV files are located in the shared `../data/` directory at the project root.
...
# Shared data at project root:
../data/                        # CSV seed files (shared across platforms)
```
