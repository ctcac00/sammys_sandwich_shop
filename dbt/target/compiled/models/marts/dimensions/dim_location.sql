...
with enriched_locations as (
    select * from SAMMYS_SANDWICH_SHOP.DBT_DEV_intermediate.int_locations
),
...
select
    md5(cast(coalesce(cast(location_id as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as location_sk,
    *,
