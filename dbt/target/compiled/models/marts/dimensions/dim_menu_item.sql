...
item_costs as (
    ...
    from SAMMYS_SANDWICH_SHOP.DBT_DEV_intermediate.int_menu_item_ingredients
...
select
    md5(cast(coalesce(cast(item_id as TEXT), '_dbt_utils_surrogate_key_null_') as TEXT)) as menu_item_sk,
    *,
