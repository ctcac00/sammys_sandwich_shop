...
fct_sales_line_item as (
    select * from SAMMYS_SANDWICH_SHOP.DBT_DEV_marts.fct_sales_line_item
),
...
dim_date as (
    select * from SAMMYS_SANDWICH_SHOP.DBT_DEV_marts.dim_date
),
...
favorite_order_type as (
    ...
    from fct_sales fs
    join SAMMYS_SANDWICH_SHOP.DBT_DEV_marts.dim_order_type ot on fs.order_type_sk = ot.order_type_sk
